...
@JsonIgnoreProperties(value = {"cause", "stackTrace", "suppressed", "detailArgs", "localizedMessage", "message"},
        ignoreUnknown = true)
public abstract class JustAPICheckedException extends Exception implements JustAPIExceptionDetailsProvider {

    private final static Logger LOGGER = LoggerFactory.getLogger(JustAPICheckedException.class);
